...
class TaskRepository extends Repository
{
    ...
    {
        return Task::with(['status', 'priority', 'frequencyUnit', 'user'])
            ->where('id', $id)
    ...
    public function save($request)
    {
        ...
        // new fields
        $task->task_frequency_unit_id = $request->task_frequency_unit_id;
        $task->task_frequency_unit_value = $request->task_frequency_unit_value;
        $task->start_time = $request->start_time;
        $task->end_time = $request->end_time;
        $task->times = $request->times;

            ...
            <div className="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
                ...
                <div className="max-w-7xl mx-auto p-6 lg:p-8">
                    <div className="flex justify-center">
                        <div className='text-4xl text-red-500'>Mini Jarvis</div>
                        {/* <svg
                            viewBox="0 0 62 65"
                            fill="none"
                    ...
                    <div className="mt-16">
                        <div className="grid items-center">
                            <a
                                href="https://github.com/virTripathi/mini-jarvis/blob/master/README.md"
                            ...
                            >
                                <div>
                                    ...
                                    <p className="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                        Mini Jarvis has a great documentation in it's readme file, please checkout...
                                    </p>
                                </div>
                    ...
                    <div className="flex justify-center mt-16 px-6 sm:items-center sm:justify-between">
                        <div className="text-center text-sm text-gray-500 dark:text-gray-400 sm:text-left">
                            <div className="flex items-center gap-4">
                                <a
                                    href="https://github.com/virTripathi"
